<?php   
    ...
    switch ($select) {
        ...
        case '0':
            //leave message here
            $greeting = "<Say>Please leave your message after the tone...</Say><Record recordingStatusCallback=\"recording-complete.php?from=" . $_REQUEST['From'] . "\" maxLength=\"120\" /><Say>I did not receive your recording.</Say>";
            break;
        case '*':
